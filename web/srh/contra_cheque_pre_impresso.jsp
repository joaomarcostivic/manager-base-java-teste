...
function init()	{
	setContraCheque({nmRazaoSocial: (rsmDados.lines[0]['NM_RAZAO_SOCIAL']==null||rsmDados.lines[0]['NM_RAZAO_SOCIAL']=='')?"":rsmDados.lines[0]['NM_RAZAO_SOCIAL'], 
					...
					vlBaseFgts: (rsmDados.lines[0]['VL_BASE_FGTS']==null||rsmDados.lines[0]['VL_BASE_FGTS']=='')? "0,00" :(new Mask('#,###.00', "number")).format(rsmDados.lines[0]['VL_BASE_FGTS']),
...
function setContraCheque(ContraCheque)	{
	...
	newContraCheque.style.borderBottom = '1px dashed #FFFFFF;';
...
<body class="bodyGridResult" id="body" onLoad="init();getEvento();" style="background-color:#DDDDDD; overflow:auto; font-family:Arial, Helvetica, sans-serif;">
<div id="divPagina" style="overflow:auto; padding:2px; background-color:#FFFFFF; height:100%; float:left;"></div>
<div id="divContraCheque" style="display:none; height:113mm; float:left; border:2px solid #FFFFFF; white-space:nowrap;">
	<div style="width:172mm; float:left;">
        <div class="d1-line" style="height:15mm; float:left; border-bottom:2px solid #FFFFFF; border-top:2px solid #FFFFFF; border-left:2px solid #FFFFFF; border-right:2px solid #FFFFFF;">
            <div class="element" style="width:65mm; height:15mm; float:left; padding-top:6mm;">
				<div class="field" id="nmRazaoSocial" style="font-size:11px; font-weight:bold; text-align:left;">#NM_RAZAO_SOCIAL</div>
			</div>
            <div class="element" style="width:30mm; height:15mm; float:left; padding-top:6mm;">
				<div class="field" id="nrCnpj" style="font-size:10px; font-weight:bold; text-align:center;">#NR_CNPJ</div>
			</div>
            <div class="element" style="width:63mm; float:left; height:15mm; padding-top:6mm;">
				<div class="field" id="nrMesAno" style="font-size:10px; font-weight:bold; text-align:right;">&nbsp;</div>
        ...
        <div class="d1-line" style="height:5mm; float:left; border-left:2px solid #FFFFFF; border-right:2px solid #FFFFFF;">
            <div class="element" style="width:19mm; float:left; height:5mm;">
				<label class="caption">&nbsp;</label>
				<div class="field" id="nrMatricula" style="font-weight:bold; text-align:left;">#NR_MATRICULA</div>
			</div>
            <div class="element" style="width:62mm; float:left; height:5mm;">
				<label class="caption">&nbsp;</label>
				<div class="field" id="nmFuncionario" style="font-weight:bold; text-align:left;">#NM_PESSOA</div>
			</div>
            <div class="element" style="width:15mm; float:left; height:5mm;">
				<label class="caption">&nbsp;</label>
        ...
        <div class="d1-line" style="height:6mm; float:left; border-bottom:2px solid #FFFFFF; border-left:2px solid #FFFFFF; border-right:2px solid #FFFFFF;">
        ...
        <div class="d1-line" style="height:8mm; float:left; border-bottom:2px solid #FFFFFF; border-left:2px solid #FFFFFF; border-right:2px solid #FFFFFF;">
            <div class="element" style="width:12mm; float:left; height:8mm;">
				<div class="field" style="text-align:center; font-weight:bold; font-size:8px; padding-top:2px;">&nbsp;</div>
			</div>
            <div class="element" style="width:72mm; float:left; height:8mm; border-left:2px solid #FFFFFF; padding-left:7px;">
				<div class="field" style="text-align:center; font-weight:bold; font-size:8px; padding-top:2px;">&nbsp;</div>
			</div>
            <div class="element" style="width:17mm; float:left; height:8mm; border-left:2px solid #FFFFFF;">
				<div class="field" style="text-align:center; font-weight:bold; font-size:8px; padding-top:2px;">&nbsp;</div>
			</div>
            <div class="element" style="width:30mm; float:left; height:8mm; border-left:2px solid #FFFFFF;">
				<div class="field" style="text-align:center; font-weight:bold; font-size:8px; padding-top:2px;">&nbsp;</div>
			</div>
            <div class="element" style="width:33mm; float:left; height:8mm; border-left:2px solid #FFFFFF;">
				<div class="field" style="text-align:center; font-weight:bold; font-size:8px; padding-top:2px;">&nbsp;</div>
			</div>
		</div>
		...
		<!-- EVENTOS ------------------>
		<div id="divEvento" style="height:68mm; float:left;"></div>



        <div class="d1-line" style="height:7mm; float:left; border-top:2px solid #FFFFFF; border-bottom:2px solid #FFFFFF; border-left:2px solid #FFFFFF; border-right:2px solid #FFFFFF;">
            <div class="element" style="width:101mm; float:left; height:7mm; border-right:2px solid #FFFFFF; padding-left:11px;">
				<div class="field" style="font-weight:bold; text-align:left; padding-top:2mm;">1ª Via</div>
			</div>
            <div class="element" style="width:30mm; float:left; height:7mm; border-right:2px solid #FFFFFF;">
				<div class="field" id="vlTotalProvento" style="font-weight:bold; padding-top:2mm; text-align:right;">#VL_TOTAL_PROVENTO</div>
			</div>
            <div class="element" style="width:33mm; float:left; height:7mm;">
        ...
        <div class="d1-line" style="height:7mm; float:left; border-bottom:2px solid #FFFFFF; border-left:2px solid #FFFFFF; border-right:2px solid #FFFFFF;">
            <div class="element" style="width:101mm; float:left; height:7mm; border-right:2px solid #FFFFFF; padding-left:11px;">
				<div class="field" style="font-weight:bold; font-size:8px; padding-top:2mm; text-align:left;">&nbsp;</div>
			</div>
            <div class="element" style="width:30mm; float:left; height:7mm; border-right:2px solid #FFFFFF;">
				<div class="field" style="font-weight:bold; text-align:center; padding-top:2mm;">&nbsp;</div>
			</div>
            <div class="element" style="width:33mm; float:left; height:7mm; background-color:#FFFFFF">
        ...
        <div class="d1-line" style="height:7mm; float:left; border-bottom:2px solid #FFFFFF; border-left:2px solid #FFFFFF; border-right:2px solid #FFFFFF;">
            <div class="element" style="width:28mm; float:left; height:7mm; text-align:center">
				<label class="caption">&nbsp;</label>
            ...
            <div class="element" style="width:39mm; float:left; height:7mm; text-align:center">
				<label class="caption">&nbsp;</label>
				<div class="field" id="vlBaseIrrf" style="font-weight:bold; text-align:center;">#VL_BASE_FGTS</div>
			</div>
            <div class="element" style="width:18mm; float:left; height:7mm; text-align:center">
				<label class="caption">&nbsp;</label>
				<div class="field" id="prIrrf" style="font-weight:bold; text-align:center;">#VL_FGTS</div>
			</div>
            <div class="element" style="width:47mm; float:left; height:7mm; text-align:center">
				<label class="caption">&nbsp;</label>
				<div class="field" id="vlBaseFgts" style="font-weight:bold; text-align:center;">#VL_BASE_IRRF</div>
			</div>
            <div class="element" style="width:10mm; float:left; height:7mm; text-align:center">
				<label class="caption">&nbsp;</label>
				<div class="field" id="vlFgts" style="font-weight:bold; text-align:center;">#VL_FAIXA_IRRF</div>
			</div>
		</div>
    </div>
</div>	
...
<div id="divEventoDetalhe" style="display:none; float:left; border:2px solid #FFFFFF; white-space:nowrap;">
	<div class="d1-line" id="divEventoPrincipal" style="height:4mm; float:left; border-left:2px solid #FFFFFF; border-right:2px solid #FFFFFF;">
		...
		<div class="element" style="width:72mm; float:left; height:4mm; border-left:2px solid #FFFFFF; padding-left:7px;">
			<div class="field" id="nmEventoFinanceiro" style="text-align:left;">#NM_EVENTO_FINANCEIRO</div>
		</div>
		<div class="element" style="width:17mm; float:left; height:4mm; border-left:2px solid #FFFFFF;">
			<div class="field" id="qtEvento" style="text-align:center;">#QT_EVENTO</div>
		</div>
		<div class="element" style="width:30mm; float:left; height:4mm; border-left:2px solid #FFFFFF;">
			<div class="field" id="vlProvento" style="text-align:right;">#VL_PROVENTO</div>
		</div>
		<div class="element" style="width:33mm; float:left; height:4mm; border-left:2px solid #FFFFFF;">
