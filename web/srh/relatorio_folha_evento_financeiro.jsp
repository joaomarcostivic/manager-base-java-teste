...
function init()	{
	...
	for(var i=0; rsmFolhaPagamento!=null && i<rsmFolhaPagamento.lines.length; i++)
		$('cdFolhaPagamento').options[$('cdFolhaPagamento').options.length] = new Option(_monthNames[rsmFolhaPagamento.lines[i]['NR_MES']-1] + "/" + rsmFolhaPagamento.lines[i]['NR_ANO'], rsmFolhaPagamento.lines[i]['CD_FOLHA_PAGAMENTO'], false, false);
...
<div style="width:435px;" class="d1-form">
  <div style="width:435px; height:156px;" class="d1-body" id="divBody">
	...
	<div class="d1-line" id="line6" style="float:right; width:165px; margin:4px 0px 0px 0px;">
		...
		<div style="width:80px;" class="element">
			<button id="btnCancelar" title="Voltar para a janela anterior" onclick="parent.closeWindow('jRelatorioFolhaEvento');" style="margin-left:2px; width:80px; border:1px solid #999999" class="toolButton">
