...
<body load="onLoad()">
	<div class="row selecao-form">
        <form id="stInscricaoBoletoForm" method="post" class="col-md-8 col-md-offset-2" OnSubmit="return false;">
        	<h3>Emissão de boleto bancário e/ou comprovante de inscrição</h3>
        	<hr>
