                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-7 col-lg-4">
                            ...
                            <!-- <div class="info-box effected" data-toggle="tooltip" title="Sistema EDF Angular" data-url="./v2/" >
	                            <span class="bg-orange info-box-icon"><i class="fa fa-angle-up"></i></span>
	                            <div class="info-box-content">
                            ...
                            <div class="info-box effected" data-toggle="tooltip" title="Módulo do Professor" data-url="./portal_professor">
                                <span class="bg-green info-box-icon"><i class="fa fa-chalkboard-teacher"></i></span>
                                <div class="info-box-content">
                            ...
                            <!--<div class="info-box effected" data-toggle="tooltip" title="Módulo do Responsável" data-module="">
                                <span class="bg-gray-active info-box-icon"><i class="fa fa-male"></i></span>
                                <div class="info-box-content">
                            ...
                            <div class="info-box effected" data-toggle="tooltip" title="Matrícula online" data-url="./matricula_online">
                                <span class="bg-red info-box-icon"><i class="fa fa-user"></i></span> <!-- bg-teal -->
                                <div class="info-box-content">
                                    <span class="info-box-text">Matrícula online</span>
                                    <p class="text-muted info-box-description">Módulo para a realização da matrícula online nos periodos disponíveis</p>
                                </div>
                                <!-- /.info-box-content -->
                            </div>
                        </div>
...
<!--                             <hr class="hidden-lg hidden-md hidden-sm" /> -->
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-7 col-lg-5">
                            <hr class="hidden-lg hidden-md hidden-sm" />
                            <h3>
                                <small><i class="fa fa-book text-muted"></i></small> Documentos oficiais
                            </h3>
                            <div class="well well-sm clearfix">
                ...
                <div id="smed">
                    <div class="col-xs-12 col-sm-6 col-md-5 col-lg-4">
                        ...
                        <div class="info-box effected" data-toggle="tooltip" title="Recursos Humanos" data-module="09SRH">
                            <span class="bg-aqua info-box-icon"><i class="fa fa-users"></i></span>
                            <div class="info-box-content">
                        ...
                        <div class="info-box effected" data-toggle="tooltip" title="Processo Administrativo Eletrônico" data-module="10PAE">
                            <span class="bg-teal info-box-icon"><i class="fa fa-file-alt"></i></span>
                            <div class="info-box-content">
                        ...
                        <div class="info-box effected" data-toggle="tooltip" title="Alimentação Escolar" data-module="06CAE">
                            <span class="bg-green info-box-icon"><i class="fa fa-utensils"></i></span>
                            <div class="info-box-content">
                        ...
                        <div class="info-box effected" data-toggle="tooltip" title="Pedagógico" data-url="./portal_pedagogico" style="cursor: pointer;">
                            <span class="bg-maroon info-box-icon"><i class="fa fa-school" aria-hidden="true"></i></span>
                            <div class="info-box-content">
                        ...
                        <div class="info-box effected" data-toggle="tooltip" title="Biblioteca" data-module="04BLB">
                            <span class="bg-blue info-box-icon"><i class="fa fa-book"></i></span>
                            <div class="info-box-content">
                                <span class="info-box-text">Bilioteca</span>
                                <p class="text-muted info-box-description">Módulo de Biblioteca Escolar</p>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                        <div class="info-box effected" data-toggle="tooltip" title="Apoio à Decisão (BI)" data-module="13BI">
                            <span class="bg-blue info-box-icon"><i class="fa fa-chart-line"></i></span>
                            <div class="info-box-content">
                        ...
                        <div class="col-sm-6">
                            <div class="panel">
                                <div class="panel-body p-t-10">
                                    <div class="media-main">
                                        <a class="pull-left" href="#">
                                        <img class="thumb-lg img-circle bx-s" src="./imagens/brasao.png" alt="">
                                        </a>
                                        <div class="info">
