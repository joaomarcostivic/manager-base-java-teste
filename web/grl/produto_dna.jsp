...
function changeLayoutDadosComplementares() {
	tabDadosComplementares = TabOne.create('tabDadosComplementares', {width: 880, height: 295, plotPlace: 'divAbaDadosComplementares', tabPosition: ['top', 'left'], style: 'margin-top:200px;',
															tabs: [{caption: 'Parâmetros', reference:'divAbaParametros', active: true},
	...
	if (content==null && $('cdProdutoServico').value != 0) {
		...
		var rsmSubstituto = null;
 		...
 		gridSubstituto = GridOne.create('gridSubstituto', {columns: [{label: 'Nome', reference: 'NM_PRODUTO_SERVICO'},
 			                                                         {label: 'Descrição', reference: 'TXT_PRODUTO_SERVICO'}],
                                                         onDoubleClick:function() {
...
// 	else {
		...
		gridCaracteristicas = GridOne.create('gridCaracteristicas', {columns: [{label: 'Nome', reference: 'ID_PRODUTO_SERVICO'},
		                                                             		   {label: 'Características', reference: 'NM_PRODUTO_SERVICO'}],
...
// 	else {
		...
		gridOutrosCodigos = GridOne.create('gridOutrosCodigos', {columns: [{label: 'Código', reference: 'ID_PRODUTO_SERVICO'},
		                                                             {label: 'Descrição', reference: 'NM_PRODUTO_SERVICO'}],
      ...
      <div id="divPrincipal">
	      <div class="d1-line" id="line1">
		    ...
		    <div style="width: 84px;" class="element">
              ...
              <input style="width: 79px;" logmessage="Referência" class="field2" idform="produtoServico" reference="nr_referencia" datatype="STRING" id="nrReferencia" name="nrReferencia" type="text"/>
            </div>	
		  </div>
...
<!-- 	               <div style="position:absolute; top:-8px; background-color:#F4F4F4; left:5px; font-family:Geneva, Arial, Helvetica, sans-serif; font-size:10px; width:130px">Ordenação</div> -->
...
<!-- 					 <label style="font-family:Geneva, Arial, Helvetica, sans-serif; font-size:10px" for="">Código</label> -->
<!-- 					 <input type="radio" name="group1" value="Butter" style="width: 20px;margin-top:7px;" >  -->
<!-- 					 <label style="font-family:Geneva, Arial, Helvetica, sans-serif; font-size:10px" for="">Descrição</label> -->
<!-- 	               </div> -->
<!-- 	             </div> -->
<!--              </div> -->
             <div style="width: 62px; margin-top:3px;" class="element">
		        <label class="caption" for="">Códigos</label>
        ...
        <div id="divAbaDadosBasicos" style="display:none;">
          <div class="d1-line" id="line1">
            <div style="width: 40px;" class="element">
              ...
              <input logmessage="Código grupo" idform="produtoServico" reference="cd_grupo" mask="####" class="field2" style="width: 37px;" datatype="INT" id="cdGrupo" name="cdGrupo" type="text" onblur="btnFindCdGrupoOnClick(this.value);" defaultvalue="<%=cdGrupo%>"/>
            </div>
            ...
            <div style="width: 40px; margin-left: 5px;" class="element">
              ...
              <input logmessage="Código grupo" idform="produtoServico" reference="cd_grupo2" mask="####" class="field2" style="width: 37px;" datatype="INT" id="cdGrupo2" name="cdGrupo2" type="text" onblur="btnFindCdGrupoOnClick(this.value, 'btnFindCdGrupo2OnClickAux');"/>
            </div>
          ...
          <div class="d1-line" id="line5">
            ...
            <div style="width: 92px;" class="element">
	        	...
	        	<input name="dtUltimoCusto" type="text" class="field2" id="dtUltimoCusto" style="width:85px;" nullvalue="" column="dtMovimento" relation="<%=ItemComparator.MINOR_EQUAL%>" sqltype="<%=Types.TIMESTAMP%>" maxlength="19" logmessage="Data relatório" mask="##/##/####" idform="relProduto" reference="dt_estoque" static="false" datatype="DATE" value="<%=sol.util.Util.formatDateTime(new java.util.GregorianCalendar(), "dd/MM/yyyy")%>" />
...
<!--             </div>       	 -->
		        	...
		        	<div id="divAbaSubstitutoPesquisa" style="display:none;">
		       		...
		       		<div id="divAbaSubstitutoDados" style="display:none;">
			        	...
			        	<div style="width: 870px; " class="element">
			              ...
			              <textarea style="width: 870px; height: 135px;" logmessage="Observação" class="textarea" idform="substituto" reference="txt_especificacao" datatype="STRING" id="txtEspecificacaoSubstituto" name="txtEspecificacaoSubstituto"></textarea>
			            </div>
		       		</div>
		       	</div>
       		</div>
		        	...
		        	<div id="divAbaReabastecimentoPesquisa" style="display:none;">
		       		...
		       		<div id="divAbaReabastecimentoDados" style="display:none;">
			            ...
			            <div id="divNmProdutoServicoSubstituto" style="width: 395px;" class="element">
			              <label class="caption" for="nmProdutoServicoSubstituto">Nível de Estoque Mínimo</label>
			            ...
			            <div id="divNmProdutoServicoSubstituto" style="width: 390px; margin-left:80px;" class="element">
			              <label class="caption" for="nmProdutoServicoSubstituto">Nível de Estoque Máximo</label>
        ...
        <div id="divAbaConfigFinanceira">
          <div style="width: 425px;" class="element">
	          ...
	          <select style="width: 425px;" logmessage="Tabela de Preço" registerclearlog="0" defaultValue="0" class="select2" idform="preco" reference="cd_tabela_preco" maxlength="10" id="cdTabelaPreco" name="cdTabelaPreco">
	            <option value="0">Selecione...</option>
	          </select>
	      </div>	
          <div style="width: 425px;margin-left:20px;" class="element">
            <label class="caption" for="tpReabastecimento">Versão da Lista de Preço</label>
          ...
          <div id="divNmProdutoServicoSubstituto" style="width: 105px;" class="element">
            <label class="caption" for="nmProdutoServicoSubstituto">Preço Base</label>
            <input lguppercase="true" style="text-transform: uppercase; width: 100px;" logmessage="Nome Produto" class="field2" idform="produtoServico" reference="nm_produto_servico" datatype="STRING" maxlength="256" id="nmProdutoServicoSubstituto" name="nmProdutoServicoSubstituto" type="text" />
          </div>
          <div id="divNmProdutoServicoSubstituto" style="width: 105px;" class="element">
          ...
          <div id="divNmProdutoServicoSubstituto" style="width: 105px; margin-left:20px;" class="element">
            <label class="caption" for="nmProdutoServicoSubstituto">Preço Mínimo</label>
            <input lguppercase="true" style="text-transform: uppercase; width: 100px;" logmessage="Nome Produto" class="field2" idform="produtoServico" reference="nm_produto_servico" datatype="STRING" maxlength="256" id="nmProdutoServicoSubstituto" name="nmProdutoServicoSubstituto" type="text" />
          </div>
          <div id="divNmProdutoServicoSubstituto" style="width: 105px;" class="element">
            <label class="caption" for="nmProdutoServicoSubstituto">Margem %</label>
          ...
          <div id="divNmProdutoServicoSubstituto" style="width: 110px;" class="element">
            <label class="caption" for="nmProdutoServicoSubstituto">Desconto/Acréscimo</label>
            <input lguppercase="true" style="text-transform: uppercase; width: 110px;" logmessage="Nome Produto" class="field2" idform="produtoServico" reference="nm_produto_servico" datatype="STRING" maxlength="256" id="nmProdutoServicoSubstituto" name="nmProdutoServicoSubstituto" type="text" />
          </div>
          <div id="divNmProdutoServicoSubstituto" style="width: 105px;" class="element">
            <label class="caption" for="nmProdutoServicoSubstituto">Preço Padrão</label>
            <input lguppercase="true" style="text-transform: uppercase; width: 100px;" logmessage="Nome Produto" class="field2" idform="produtoServico" reference="nm_produto_servico" datatype="STRING" maxlength="256" id="nmProdutoServicoSubstituto" name="nmProdutoServicoSubstituto" type="text" />
          </div>
          <div id="divNmProdutoServicoSubstituto" style="width: 105px;" class="element">
            <label class="caption" for="nmProdutoServicoSubstituto">Margem %</label>
          ...
          <div id="divNmProdutoServicoSubstituto" style="width: 105px; margin-left:20px;" class="element">
            <label class="caption" for="nmProdutoServicoSubstituto">Preço Máximo</label>
            <input lguppercase="true" style="text-transform: uppercase; width: 100px;" logmessage="Nome Produto" class="field2" idform="produtoServico" reference="nm_produto_servico" datatype="STRING" maxlength="256" id="nmProdutoServicoSubstituto" name="nmProdutoServicoSubstituto" type="text" />
          </div>
          <div id="divNmProdutoServicoSubstituto" style="width: 105px;" class="element">
            <label class="caption" for="nmProdutoServicoSubstituto">Margem %</label>
...
<!--         		<div class="d1-line" id="line0"> -->
		            ...
		            <div id="divStProdutoEmpresaSubstituto3" style="width: 870px;" class="element">
		            	<input type="checkbox" /> Não controlar estoque
		            </div>
		            <div id="divStProdutoEmpresaSubstituto" style="width: 870px;" class="element">
		            	<input type="checkbox" /> Imprime na tabela de preço
		            </div>
		            <div id="divStProdutoEmpresaSubstituto3" style="width: 870px;" class="element">
...
<!-- 	            </div> -->
       		...
       		<div id="divAbaFotosAdicionais" style="display:none;">
				  ...
				  <div id="divTxtEspecificacaoSubstituto" style="width: 400px;margin-left:190px;" class="element">
	              	<label class="caption" for="txtEspecificacaoSubstituto">Descrição</label>
	              	<textarea style="width: 570px; height: 205px;" logmessage="Especificações" class="textarea" idform="produtoServico" reference="txt_especificacao" datatype="STRING" id="txtEspecificacao2Substituto" name="txtEspecificacao2Substituto"></textarea>
            	  </div>
			    </div>
       		...
       		<div id="divAbaCaracteristicas" style="display:none;">
	              ...
	              <input lguppercase="true" style="text-transform: uppercase; width: 400px;" logmessage="Nome Produto" class="field2" idform="produtoServico" reference="nm_produto_servico" datatype="STRING" maxlength="256" id="nmProdutoServicoSubstituto" name="nmProdutoServicoSubstituto" type="text" />
	       	    ...
	       	    <div id="divTxtEspecificacaoSubstituto" style="width: 470px;" class="element">
	              	<label class="caption" for="txtEspecificacaoSubstituto">Características</label>
	              	<textarea style="width: 450px; height: 200px;" logmessage="Especificações" class="textarea" idform="produtoServico" reference="txt_especificacao" datatype="STRING" id="txtEspecificacao2Substituto" name="txtEspecificacao2Substituto"></textarea>
            	</div>
       		...
       		<div id="divAbaCodigoBarras" style="display:none;">
       			<div class="d1-line">
	       			 ...
	       			 <div id="divNmProdutoServicoSubstituto" style="width: 100px;" class="element">
		              	<label class="caption" for="nmProdutoServicoSubstituto">Código de Barras</label>
		             ...
		             <div id="divNmProdutoServicoSubstituto" style="width: 300px;" class="element">
		              	<label class="caption" for="nmProdutoServicoSubstituto">Descrição</label>
		             ...
		             <div style="width: 840px;" class="element">
		               <label class="caption">Códigos de Barra</label>
       		...
       		<div id="divAbaOutrosCodigos" style="display:none;">
       			<div class="d1-line">
	       			 ...
	       			 <div id="divNmProdutoServicoSubstituto" style="width: 100px;" class="element">
		              	<label class="caption" for="nmProdutoServicoSubstituto">Código</label>
		              	<input lguppercase="true" style="text-transform: uppercase; width: 95px;" logmessage="Nome Produto" class="field2" idform="produtoServico" reference="nm_produto_servico" datatype="STRING" maxlength="256" id="nmProdutoServicoSubstituto" name="nmProdutoServicoSubstituto" type="text" />
		             </div>
		             <div id="divNmProdutoServicoSubstituto" style="width: 300px;" class="element">
		              	<label class="caption" for="nmProdutoServicoSubstituto">Descrição</label>
        ...
        <div id="divAbaLoja" style="display:none;">
			<div id="divNmProdutoServicoSubstituto" style="width: 880px;" class="element">
              <label class="caption" for="nmProdutoServicoSubstituto">Descrição do produto na Loja Virtual</label>
        ...
        <div id="divAbaEspecificacoes">
        	<div id="divTxtEspecificacaoSubstituto" style="width: 870px;" class="element">
              ...
              <textarea style="width: 880px; height: 280px;" logmessage="Especificações" class="textarea" idform="produtoServico" reference="txt_especificacao" datatype="STRING" id="txtEspecificacao2Substituto" name="txtEspecificacao2Substituto"></textarea>
            </div>
        </div>
