...
<title>Central de Atendimento Externo</title>
<script language="javascript">
	...
	function miLoginOnClick(msg) {
		createWindow('jLogin', {caption: 'Login', 
							...
							width: 350, 
							height: 180, 
							contentUrl: '/dotManager/login.jsp?idModulo=crm&callback=parent.onLogin&lgEscolherEmpresa=1',
							modal:true});
	}
	
	function onLogin(user){
		window.resizeTo(830, 560);
		document.location = '/dotManager/crm/index.jsp?cdEmpresa='+user.cdEmpresa+'&cdUsuario='+user.cdUsuario;
	}
...
<body style="margin:0px;">
    <div style="width:701px; height:335px; background-color:#CCCCCC; padding:10px; margin:50px auto;">
    	<div style="height:335px; background-color:#F6F6F6; background-image:url(imagens/fundo_portal.jpg); background-position:bottom left; background-repeat:no-repeat; position:relative">
            ...
            <div style="position:absolute; top:6px; right:10px; height:30px; margin:10px; font-family:Geneva, Arial, Helvetica, sans-serif; font-size:36px; color:#666666; white-space:nowrap; text-transform:capitalize;"><%=(central!=null)?central.getNmCentral().toUpperCase():"Nenhuma central configurada"%></div>
            <%
				if(central!=null){
				%>
