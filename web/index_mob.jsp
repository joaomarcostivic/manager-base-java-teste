...
<!--                         <li class="nav-header"> -->
<!--                             <a href="#" data-toggle="collapse" data-target="#menu2" data-id="orgao"> <i class="fa fa-university"></i> Para o Órgão </a> -->
<!--                         </li> -->
                        <li class="nav-header">
                ...
                <div class="sidebar-bottom" style="z-index: 0 !important; position: absolute;  bottom: 2px;">
                    <div class="col-md-8 col-xs-9">
                    	<img class="logo img-responsive" src="./imagens/logo-tivic-small_branco.png" data-url="http://tivic.com.br/" target="_blank">
                    </div>
                </div>
            </div>
                ...
                <div id="principal" class="active">                    
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-7 col-lg-4">
                            ...
                            <div class="info-box effected" data-toggle="tooltip" title="Módulo Administrativo" data-url="./mv/#/administrativo">
                                <span class="bg-blue info-box-icon"><i class="fas fa-sitemap"></i></span>
                                <div class="info-box-content">
                                    <span class="info-box-text">Administrativo</span>
                                    <p class="text-muted info-box-description">Módulo de Administração do Órgão de Trânsito</p>
                                </div>
                            </div>
                            <div class="info-box effected" data-toggle="tooltip" title="Módulo de Processamento" data-url="./mv/#/processamento">
                                <span class="bg-green info-box-icon"><i class="fas fa-microchip"></i></span>
                                <div class="info-box-content">
                            ...
                            <!-- /.info-box -->
                            <div class="info-box effected" data-toggle="tooltip" title="Módulo de Monitoramento" data-url="./mv/#/monitoramento">
                                <span class="bg-yellow info-box-icon"><i class="fa fa-desktop"></i></span>
                                <div class="info-box-content">
                            ...
                            <!-- /.info-box -->
<!--                             <div class="info-box effected" data-toggle="tooltip" title="Módulo de Fiscalização" data-url="./mv/#/fiscalizacao"> -->
<!--                                 <span class="bg-orange info-box-icon"><i class="fas fa-user-shield"></i></span> -->
<!--                                 <div class="info-box-content"> -->
<!--                                     <span class="info-box-text">Fiscalização</span> -->
<!--                                     <p class="text-muted info-box-description">Módulo de Gerenciamento de Supervisão de Campo/Fiscalização</p> -->
<!--                                 </div> -->
<!--                             </div> -->
                            <div disabled class="info-box effected" data-toggle="tooltip" title="Módulo de Transporte" data-url="./flex/Manager.jsp?p=mob&m=MOB">
                                <span class="bg-red info-box-icon"><i class="fas fa-bus-alt"></i></span>
                                <div class="info-box-content">
                                    <span class="info-box-text">Transporte</span>
                                    <p class="text-muted info-box-description">Módulo de Gerenciamento de Transportes</p>
                                </div>
                                <!-- /.info-box-content -->
                            </div>
                            <!-- /.info-box -->
<!--                             <div class="info-box effected" data-toggle="tooltip" title="Módulo de Impressões" data-url="./mv/#/impressao"> -->
<!--                                 <span class="bg-orange info-box-icon"><i class="fas fa-print"></i></span> -->
<!--                                 <div class="info-box-content"> -->
<!--                                     <span class="info-box-text">Impressões</span> -->
<!--                                     <p class="text-muted info-box-description">Módulo de Gerenciamento de Impressões</p> -->
<!--                                 </div> -->
<!--                                 /.info-box-content -->
<!--                             </div> -->
<!--                             /.info-box -->
<!--                             <div class="info-box effected" data-toggle="tooltip" title="Módulo de BI" data-url="./mv/#/bi"> -->
