...
function init() {
	...
	$('.weather').weatherApi({
		...
		success: function(weather){
			...
			$(".weather-loading").eq(0).slideUp('slow', function(){
// 				$(this).hide();
			});
		}
	});
...
<body class="metro" onload="init();onLogin();" style="overflow: hidden !important;">
	<div class="tile-area tile-area-dark"
		style="background: url(http://www.nsrelief.com/wp-content/uploads/2014/01/Background11.jpg) #ffffff no-repeat !important; background-position: bottom left; background-attachment: fixed;">
		<h1 class="tile-area-title">
			<img src="../edf/imagens/logo_ico.png"> Portal do Aluno
		</h1>
		...
		<div class="tile-group three modulos">			
			...
			<a href="#" class="tile double bg-darkGreen modulo-tile">
				<div class="tile-content icon">
					<span class="icon-copy"></span>
				</div>
				<div class="brand">
					<div class="label">Assuntos e Materiais</div>
				</div>
			</a>
		...
		<div class="tile-group two modulos">			
			...
			<a href="#" class="tile bg-teal modulo-tile">
				<div class="tile-content icon">
					<span class="icon-list"></span>
				</div>
				<div class="brand">
					<div class="label">Boletim</div>
				</div>
			</a>
			
			<a href="#" class="tile bg-darkTeal modulo-tile">
				<div class="tile-content icon">
