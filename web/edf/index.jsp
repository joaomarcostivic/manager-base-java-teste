                ...
                <div id="principal" class="active">                    
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-7 col-lg-4">
                            ...
                            <!-- /.info-box -->
                            <div class="info-box effected" data-toggle="tooltip" title="Módulo do Professor" data-module="02PROF">
                            ...
                            <!-- /.info-box -->
                            <div class="info-box disabled" data-toggle="tooltip" title="Módulo do Aluno" data-module="">
                                <span class="bg-gray-active info-box-icon"><i class="fa fa-graduation-cap"></i></span> <!-- bg-yellow -->
                                <div class="info-box-content">
                        ...
                        <hr class="hidden-lg hidden-md hidden-sm" />  
                            ...
                            <div class="well well-sm clearfix">
                                ...
                                <a href="http://www.pmvc.ba.gov.br/noticias/" target="_blank" class="btn btn-sm btn-link pull-right">VER MAIS</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    $xml.find("item").each(function(i, val) {
                        if (i < 5) {
                            ...
                            $col1.append(
                                $("<div />").css({
                                    'height': '50px',
                                    'background': 'url(' + (img ? img.src : nmRoot + '/edf/imagens/noticia.jpg')+ ')',
                                    'background-size': 'cover'
                                })
                            );
