    ...
    <body>
        <div class="row content">
            <div class="sidebar col-md-2 col-xs-4">
                <div class="col-md-12"><img class="logo img-responsive" src="http://www.tivic.com.br/public/images/mob-logo.png">
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12" class="update-list">
                        ...
                        <%
                            ...
                            while(releases.next()){ 
                            %>
                        <h5><span class="label text-sm label-success">Versão (<%=releases.getString("NR_FULL_VERSION")%>)</span> 
                        	<span class="label text-sm label-primary">Atualizado em: <%=releases.getDateFormat("DT_RELEASE", "dd/MM/yyyy")%></span>
                        	<span class="label text-sm label-primary">Módulo: <%=releases.getString("NM_SISTEMA")%></span></h5>
        ...
        <script>
            ...
            $(function(){
            	var videos = [
            		{id: 'OjtbzaCW08U', title: 'SEMOB - Portal de Acesso', desc: "Vídeo aula para te instruir sobre o portal de acesso ao sistema."},
            		{id: '8asXaGUnq38', title: 'SEMOB - Cadastro do PNE', desc: "Vídeo aula para te instruir no cadastro de pessoa com necessidade especial."},   	              	
            		{id: 'mWc9zntwakA', title: 'SEMOB - Gerenciamento de Solicitações', desc: "Vídeo aula para te instruir no gerenciamento de solicitações de pessoa com necessidade especial."}
