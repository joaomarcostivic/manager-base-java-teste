...
public class AgendaItemOcorrencia {
	...
	public AgendaItemOcorrencia(){ }

	public AgendaItemOcorrencia(int cdOcorrencia,
			int cdAgendaItem,
	...
	public String toString() {
		...
		valueToString += ", dtCadastro: " + getDtCadastro();
		return "{" + valueToString + "}";
	}

	public Object clone() {
		return new AgendaItemOcorrencia(getCdOcorrencia(),
			getCdAgendaItem(),
			getCdTipoOcorrencia(),
			getCdUsuario(),
