...
public class ConsultaSincronizadorCidadeService implements IConsultaSincronizadorService {
	private ISincronizadorClient sincronizadorClient;
	
	public ConsultaSincronizadorCidadeService() throws Exception {
	...
	public JSONArray consult() throws Exception {
		JSONObject jsonCategorias = sincronizadorClient.getData("cidades");
		return jsonCategorias.getJSONArray("cidades");
	}
