...
public class AitMovimentoOld {
	...
	private GregorianCalendar dtExpedicao;
	private byte[] dsObservacao;

	public AitMovimentoOld() { }

	public AitMovimentoOld(int codigoAit,
			int nrMovimento,
	...
	public void setDtExpedicao(GregorianCalendar dtExpedicao){
		this.dtExpedicao=dtExpedicao;
	}
	public GregorianCalendar getDtExpedicao(){
	...
	public String toString() {
		...
		valueToString += ", dtExpedicao: " +  sol.util.Util.formatDateTime(getDtExpedicao(), "dd/MM/yyyy HH:mm:ss:SSS", "");
		valueToString += ", dsObservacao: " +  getDsObservacao();
		return "{" + valueToString + "}";
	}

	public Object clone() {
		return new AitMovimentoOld(getCodigoAit(),
			getNrMovimento(),
			...
			getCdUsuario(),
			getCdContaReceber(),
			getDtExpedicao()==null ? null : (GregorianCalendar)getDtExpedicao().clone(),
			getDsObservacao());
	}
