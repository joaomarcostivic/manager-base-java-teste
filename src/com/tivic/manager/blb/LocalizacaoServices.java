...
public class LocalizacaoServices {
	...
	public static Result remove(int cdLocalizacao){
		return remove(cdLocalizacao, false, null);
	}
	public static Result remove(int cdLocalizacao, boolean cascade){
		return remove(cdLocalizacao, cascade, null);
	}
	public static Result remove(int cdLocalizacao, boolean cascade, Connection connect){
		boolean isConnectionNull = connect==null;
		try {
			if (isConnectionNull) {
				connect = Conexao.conectar();
			...
			retorno = LocalizacaoDAO.delete(cdLocalizacao, connect);
			if(retorno<=0){
				Conexao.rollback(connect);
...
public static ResultSetMap getAll() {
	...
	public static ResultSetMap getAll(Connection connect) {
		...
		try {
			...
			System.err.println("Erro! LocalizacaoServices.getAll: " + sqlExpt);
			return null;
		}
		catch(Exception e) {
			e.printStackTrace(System.out);
			System.err.println("Erro! LocalizacaoServices.getAll: " + e);
			return null;
		}
		finally {
			if (isConnectionNull)
