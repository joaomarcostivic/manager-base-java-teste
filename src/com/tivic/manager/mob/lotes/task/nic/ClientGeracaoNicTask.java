...
import com.tivic.manager.mob.lotes.exception.UsuarioNaoLocalizadoException;
import com.tivic.manager.mob.lotes.impressao.viaunica.GeradorNic;
import com.tivic.manager.mob.lotes.validator.nic.ValidadorGeracaoNIC;
...
public class ClientGeracaoNicTask implements IClientGeracaoNicTask {
	...
	private int getUsuario(CustomConnection customConnection) throws Exception, UsuarioNaoLocalizadoException {
		SearchCriterios searchCriterios = new SearchCriterios();
		...
		if (usuario.isEmpty()) {
			throw new UsuarioNaoLocalizadoException("Usuário TIVIC não localizado.");
		}
