...
public class SemDefesaValidator implements IValidator<Ait> {
	...
	public SemDefesaValidator() throws Exception {
	...
	private CorreiosEtiqueta getEtiqueta(int cdAit, int tpStatus) throws Exception {
		...
		List<CorreiosEtiqueta> correiosEtiquetaList = correiosEtiquetaRepository.find(searchCriterios, new CustomConnection());
