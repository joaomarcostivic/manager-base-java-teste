...
public class CodigoBarras {
	...
	public String getCodigoBarrasSemDv() {
		return codigoBarrasSemDv;
	}

	public void setCodigoBarrasSemDv(String codigoBarrasSemDv) {
		this.codigoBarrasSemDv = codigoBarrasSemDv;
	}
	...
	public String toString() {
		return "CodigoBarras [identificadorArrecadacao=" + identificadorArrecadacao + ", identificadorSegmento="
				...
				+ codigoInfracao + ", codigoBarrasComDv=" + codigoBarrasComDv + ", codigoBarrasSemDv=" + codigoBarrasSemDv + ", linhaDigitavel=" + linhaDigitavel
