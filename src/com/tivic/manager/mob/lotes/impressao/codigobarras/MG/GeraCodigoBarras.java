package com.tivic.manager.mob.lotes.impressao.codigobarras.MG;
...
import com.tivic.manager.mob.lotes.impressao.codigobarras.IGerarCodigoBarras;
...
public class GeraCodigoBarras implements IGerarCodigoBarras {
	...
	@Override
	public CodigoBarras gerarCodigoBarras(Notificacao dadosNotificacao, ReportCriterios reportCriterios) {
	...
	private void gerarCodigoBarrasComDV(CodigoBarras codigoBarras){
		...
		codigoBarras.setCodigoBarrasSemDv(codigoBarrasSemDv);
