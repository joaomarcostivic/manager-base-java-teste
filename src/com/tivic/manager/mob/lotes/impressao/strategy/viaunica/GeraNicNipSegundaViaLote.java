...
public class GeraNicNipSegundaViaLote extends TipoImpressaoNotificacaoHandler {
	private AitMovimentoRepository aitMovimentoRepository;
	private ILoteImpressaoService loteImpressaoService;
	private AitRepository aitRepository;

	public GeraNicNipSegundaViaLote() throws Exception {
	...
	public byte[] gerar(TipoImpressaoNotificacao tipoImpressaoNotificacao, CustomConnection customConnection) throws Exception {
		if (verificarAitNic(tipoImpressaoNotificacao.getCdAit(), customConnection)
			...
			LoteImpressao loteNotificacaoNipViaUnica = this.loteImpressaoService.gerarLoteNotificacaoAitViaUnica(aitList, tipoImpressaoNotificacao.getCdUsuario(), TipoLoteImpressaoEnum.LOTE_NIC_NIP.getKey());
			...
			return this.loteImpressaoService.imprimirLoteNotificacao(loteNotificacaoNipViaUnica.getCdLoteImpressao(), customConnection);
		} else {
