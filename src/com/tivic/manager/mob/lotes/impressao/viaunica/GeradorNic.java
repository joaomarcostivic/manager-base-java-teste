package com.tivic.manager.mob.lotes.impressao.viaunica;
...
import com.tivic.manager.mob.lotes.builders.nic.AitNicBuilder;
import com.tivic.manager.mob.lotes.movimento.viaunica.MovimentosAitNicGenerator;
...
public class GeradorNic {
	...
	public void generate(Ait ait, int cdUsuario, CustomConnection customConnection) throws Exception {
		...
		new MovimentosAitNicGenerator().gerarMovimentos(this.ait, cdUsuario, customConnection);
