...
public class ListAitsCandidatosNicNipViaUnicaService implements IListAitsCandidatasNotificacao {
	private CustomConnection customConnection;
	private List<Ait> aitList;
	private SearchCriterios searchCriterios;
	
	
	public ListAitsCandidatosNicNipViaUnicaService(SearchCriterios searchCriterios, CustomConnection customConnection) throws Exception {
