...
public class TipoImpressaoNotificacaoBuilder {
	...
	private SearchCriterios searchCriteriosLote(int cdAit) {
		...
		search.addCriterios("A.tp_impressao", String.valueOf(TipoLoteImpressaoEnum.LOTE_NAI.getKey()) + ", " +
	            String.valueOf(TipoLoteImpressaoEnum.LOTE_NIC_NAI.getKey()), ItemComparator.IN, Types.INTEGER);
