...
public class GeraMovimentoNotificacaoNipViaUnica implements IGeraMovimentoNotificacao {
	...
	public GeraMovimentoNotificacaoNipViaUnica() throws Exception {
	...
	private void verificarEnvioNip(Ait ait, CustomConnection customConnection) throws ValidacaoException, Exception {
		AitMovimento nipEnviada = this.aitMovimentoService.getMovimentoTpStatus(ait.getCdAit(), TipoStatusEnum.NIP_ENVIADA.getKey());
