...
public class AitDtInfracaoDeserializeDTO extends AitDtInfracaoDeserialize {
	...
	public static class ListBuilder {
		...
		private ResultSetMapper<AitDtInfracaoDeserializeDTO> aits;
		...
		public ListBuilder(ResultSetMap rsm) {
			try {
				this.aits = new ResultSetMapper<AitDtInfracaoDeserializeDTO>(rsm, AitDtInfracaoDeserializeDTO.class);
				setInfracao(rsm);
		...
		public List<AitDtInfracaoDeserializeDTO> build() throws IllegalArgumentException, Exception {
			
			List<AitDtInfracaoDeserializeDTO> aits = this.aits.toList();
			...
			for(int i = 0; i < aits.size(); i++) {
				AitDtInfracaoDeserializeDTO dto = aits.get(i);
	...
	public static class Builder {
		...
		private AitDtInfracaoDeserializeDTO dto;
		
		public Builder(Map<String, Object> map) {
			try {
				mapper = new ObjectMapper();
				mapper.configure(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES, false);
				dto = mapper.readValue(Util.map2Json((HashMap<String, Object>)map).toString(), AitDtInfracaoDeserializeDTO.class);
		...
		public Builder(int cdAit, boolean cascade) {
			try {
				...
				dto = objectMapper.readValue(ait.toString(), AitDtInfracaoDeserializeDTO.class);
		...
		public AitDtInfracaoDeserializeDTO build() {
			return dto;
		}
