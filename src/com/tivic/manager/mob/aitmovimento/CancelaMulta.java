...
public class CancelaMulta {
	
	private AitMovimentoRepository aitMovimentoRepository;
	private CustomConnection customConnection;
	private AitMovimento aitMovimento;
	
	public CancelaMulta(int cdAit, AitMovimento aitMovimento, CustomConnection customConnection ) throws Exception {
	...
	private void cancelar() throws Exception {
		...
		this.aitMovimentoRepository.insert(cancelamentoMulta, this.customConnection);
	}
}
