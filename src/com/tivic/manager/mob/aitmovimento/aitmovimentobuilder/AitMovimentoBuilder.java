...
public class AitMovimentoBuilder {
    ...
    public AitMovimentoBuilder(AitMovimento aitMovimento) {
    	this.aitMovimento = aitMovimento;
    }
    
    public static AitMovimento buildPublicacaoDO(int cdAit, int tpStatus, GregorianCalendar dtPublicacao) {
		AitMovimento aitMovimento = new AitMovimento();
		
		aitMovimento = AitMovimentoServices.getMovimentoTpStatus(cdAit, tpStatus);
		aitMovimento.setDtPublicacaoDo(dtPublicacao);
    ...
    public AitMovimentoBuilder setDtMovimento() {
		aitMovimento.setDtMovimento(new GregorianCalendar());
		return this;
	}
    
    public AitMovimentoBuilder setStPublicacaoDo(int stPublicacao) {
		aitMovimento.setStPublicacaoDo(stPublicacao);
		return this;
	}
