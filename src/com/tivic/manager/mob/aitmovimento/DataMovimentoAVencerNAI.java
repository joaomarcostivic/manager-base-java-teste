...
public class DataMovimentoAVencerNAI implements IDataMovimentoAVencer {

	private AitRepository aitRepository;
	private TabelasAuxiliares tabelasAuxiliares;

	public DataMovimentoAVencerNAI() throws Exception {
	...
	public GregorianCalendar calcularVencimento(int cdAit) throws Exception {
		...
		int prazo = tabelasAuxiliares.getPrazoMovimento(TipoStatusEnum.NAI_ENVIADO.getKey());
