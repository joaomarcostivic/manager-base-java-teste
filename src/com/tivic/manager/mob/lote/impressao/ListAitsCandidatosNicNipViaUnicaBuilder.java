...
public class ListAitsCandidatosNicNipViaUnicaBuilder implements IListAitsCandidatasNotificacao {
	private CustomConnection customConnection;
	private List<Ait> aitList;
	private SearchCriterios searchCriterios;
	
	
	public ListAitsCandidatosNicNipViaUnicaBuilder(SearchCriterios searchCriterios, CustomConnection customConnection) throws Exception {
