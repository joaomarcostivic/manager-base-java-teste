...
public class RemessaSimplesAdvertenciaBuilder implements IBuilderRemessa {
	private DadosDocumento dadosDocumento;
	private IBancoService bancoService;
	private CustomConnection customConnection;
	
	public RemessaSimplesAdvertenciaBuilder() throws Exception {
	...
	public void montarDadosRemessa(LoteImpressao loteImpressao, CustomConnection customConnection) throws Exception {
		...
		dadosDocumento.setNmDocumento("mob/notificacao_advertencia");
