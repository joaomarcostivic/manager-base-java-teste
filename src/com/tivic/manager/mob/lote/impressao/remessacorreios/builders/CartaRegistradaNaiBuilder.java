...
public class CartaRegistradaNaiBuilder implements IBuilderRemessa {
	...
	public void montarDadosRemessa(LoteImpressao loteImpressao, CustomConnection customConnection) throws Exception {
		...
		dadosDocumento.setNmDocumento((tipoAr == TipoArDigitalEnum.AR_DIGITAL.getKey() ? "mob/nai_carta_registrada_ar_digital": "mob/nai_carta_registrada_ar_digital_2D"));
	...
	private Search<DadosNotificacao> searchNais(SearchCriterios searchCriterios) throws Exception {
		Search<DadosNotificacao> search = new SearchBuilder<DadosNotificacao>("MOB_AIT A")
				.fields(  " A.cd_Ait, A.nr_renainf, A.nr_inventario_inmetro, A.id_ait, A.nr_controle, A.dt_infracao, A.dt_prazo_defesa, A.ds_observacao, A.nr_cpf_condutor, A.dt_afericao, "
