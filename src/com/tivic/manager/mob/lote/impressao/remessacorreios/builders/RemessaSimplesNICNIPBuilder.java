...
public class RemessaSimplesNICNIPBuilder implements IBuilderRemessa {
	...
	public RemessaSimplesNICNIPBuilder() throws Exception {
	...
	public void montarDadosRemessa(LoteImpressao loteImpressao, CustomConnection customConnection) throws Exception {
		...
		dadosDocumento.setNmDocumento("mob/nic_nip_v2");
