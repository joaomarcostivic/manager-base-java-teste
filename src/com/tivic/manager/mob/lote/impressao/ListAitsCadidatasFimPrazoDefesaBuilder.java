...
public class ListAitsCadidatasFimPrazoDefesaBuilder implements IListAitsCandidatasNotificacao{
	private CustomConnection customConnection;
	private List<Ait> aitList;
	private SearchCriterios searchCriterios;
	private IParametroService parametroService;
	
	public ListAitsCadidatasFimPrazoDefesaBuilder(SearchCriterios searchCriterios, CustomConnection customConnection) throws Exception {
