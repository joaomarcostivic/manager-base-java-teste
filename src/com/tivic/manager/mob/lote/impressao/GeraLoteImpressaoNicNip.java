...
public class GeraLoteImpressaoNicNip implements IGerarLoteImpressao {

	private ILoteNotificacaoService loteNotificacaoService;
	
	public GeraLoteImpressaoNicNip() throws Exception {
	...
	public LoteImpressao gerarLoteImpressao(List<Ait> aitList, int cdUsuario, CustomConnection customConnection) throws Exception {
	    ...
	    String idLoteImpressao = String.format("NIC-NIP/%s", now.format(DateTimeFormatter.ofPattern("ddMMHHmm")));
		LoteImpressao loteImpressao = new LoteImpressaoBuilder()
				...
				.addTpDocumento(TipoLoteNotificacaoEnum.LOTE_NIC_NIP.getKey())
				.build();
