...
public class GerarMovimentoFimPrazoDefeza implements IGerarAitMovimento {
	private AitMovimentoRepository movimentoRepository;
	private AitRepository aitRepository;
	private IAitMovimentoService aitMovimentoServices;
	
	public GerarMovimentoFimPrazoDefeza() throws Exception {
	...
	private AitMovimento criarMovimento(int cdAit, int cdUsuario, CustomConnection customConnection) throws Exception {
		...
		AitMovimento movimentoFimPrazoDefesa = new BuilderMovimentoFimPrazoDefesa(ait, cdUsuario).build();
