...
public class GeraLoteImpressaoNicNai implements IGerarLoteImpressao {

private ILoteNotificacaoService loteNotificacaoService;
	
	public GeraLoteImpressaoNicNai() throws Exception {
	...
	public LoteImpressao gerarLoteImpressao(List<Ait> aitList, int cdUsuario, CustomConnection customConnection) throws Exception {
		...
		String idLoteImpressao = String.format("NIC-NAI/%s", now.format(DateTimeFormatter.ofPattern("MMddHHmm")));
		LoteImpressao loteImpressao = new LoteImpressaoBuilder()
				...
				.addTpDocumento(TipoLoteNotificacaoEnum.LOTE_NIC_NAI.getKey())
				.build();
