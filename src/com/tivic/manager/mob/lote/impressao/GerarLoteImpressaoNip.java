...
public class GerarLoteImpressaoNip implements IGerarLoteImpressao{
	private ILoteNotificacaoService loteNotificacaoService;
	
	public GerarLoteImpressaoNip() throws Exception {
	...
	public LoteImpressao gerarLoteImpressao(List<Ait> aitList, int cdUsuario, CustomConnection customConnection) throws Exception {
	    ...
	    String idLoteImpressao = String.format("NIP/%s", now.format(DateTimeFormatter.ofPattern("ddMMHHmm")));
		LoteImpressao loteImpressao = new LoteImpressaoBuilder()
				...
				.addTpDocumento(TipoLoteNotificacaoEnum.LOTE_NIP.getKey())
				.build();
