...
public class GeraDocumentoSegundaViaNicNip implements IGerarSegundaViaImpressao {
	...
	public GeraDocumentoSegundaViaNicNip() throws Exception {
	...
	public byte[] gerarDocumentos(int cdAit, Boolean printPortal, CustomConnection customConnection) throws Exception, ValidacaoException {
		...
		return findDocumentoNip(cdAit, reportCriterios).getReportPdf("mob/nic_nip_v2");
	}
	...
	private String getDtPostagem(int cdAit) throws Exception {
		String dtPostagem = new GeradorDtPostagem()
				.gerar(loteImpressaoAitRepository.getDTO(cdAit, TipoLoteNotificacaoEnum.LOTE_NIC_NIP.getKey(), customConnection).getDtCriacao());
		return dtPostagem;
	}
