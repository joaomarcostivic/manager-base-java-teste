...
public class Boat {
	...
	private ArrayList<BoatVeiculo> veiculos;
	private ArrayList<BoatVitima> vitimas;
	private ArrayList<BoatTestemunha> testemunhas;
	
	private Declarante declarante;
	private DeclaranteEndereco declaranteEndereco;
	private BoatDeclarante boatDeclarante;
	...
	public Boat(int cdBoat,
			...
			int lgDanoPatrimonioPublico,
			int lgDanoMeioAmbiente,
			ArrayList<BoatImagem> imagens,
			ArrayList<BoatVeiculo> veiculos,
			ArrayList<BoatVitima> vitimas,
			ArrayList<BoatTestemunha> testemunhas) {
		setCdBoat(cdBoat);
		setNrBoat(nrBoat);
		setDtOcorrencia(dtOcorrencia);
		setTpAcidente(tpAcidente);
	...
	public Boat(int cdBoat, int nrBoat, GregorianCalendar dtOcorrencia, int tpAcidente, String nmTipoAcidenteOutro,
			int cdUsuario, int cdAgente, int cdCidade, String dsObservacao, String dsLocalOcorrencia,
			String dsPontoReferencia, Double vlLatitude, Double vlLongitude, int cdTipoAcidente, int cdCondicaoVia,
			int cdTipoPavimento, int cdCondicaoClima, int stSinalizacaoHorizontal, int stSinalizacaoVertical,
			int stSemaforo, String nmDelegaciaComunicada, GregorianCalendar dtComunicacao, String nrOcorrenciaPolicial,
			String nmAgentePolicial, String nrMatriculaAgentePolicial, String txtOcorrenciaPolicial,
			int lgPoliciaTecnica, String nmResponsavelPoliciaTecnica, int lgIml, String nmResponsavelIml,
			int lgPericiaRealizada, String nmResponsavelPericia, String lgBombeiros, String nmResponsavelBombeiros,
			int lgResgate, String nmResponsavelResgate, String nmOutroOrgao, String nmResponsavelOutroOrgao,
			byte[] blbDiagrama, byte[] imgDiagrama, String txtDescricaoSumaria, int tpCaracteristicaAcidente,
			int tpCondicaoVia, int tpPavimento, int tpCondicaoClima, String nmOutraCondicaoVia, String nmOutroPavimento,
			String nmOutraCondicaoClima, String txtDocumentosEntregues, int tpTracadoVia, int tpRelacao,
			String nrProtocolo, int stBoat, int lgDanoPatrimonioPublico, int lgDanoMeioAmbiente, ArrayList<BoatImagem> imagens, ArrayList<BoatVeiculo> veiculos,
			ArrayList<BoatVitima> vitimas, ArrayList<BoatTestemunha> testemunhas, Declarante declarante,
			DeclaranteEndereco declaranteEndereco, BoatDeclarante boatDeclarante) {
		super();
		this.cdBoat = cdBoat;
		this.nrBoat = nrBoat;
	...
	public ArrayList<BoatVeiculo> getVeiculos() {
		return veiculos;
	}
	public void setVeiculos(ArrayList<BoatVeiculo> veiculos) {
		this.veiculos = veiculos;
	}	
	public ArrayList<BoatVitima> getVitimas() {
		return vitimas;
	}
	public void setVitimas(ArrayList<BoatVitima> vitimas) {
		this.vitimas = vitimas;
	}	
	public ArrayList<BoatTestemunha> getTestemunhas() {
		return testemunhas;
	}
	public void setTestemunhas(ArrayList<BoatTestemunha> testemunhas) {
		this.testemunhas = testemunhas;
	}
