...
public class DeferimentoDocumento implements IUpdateSituacaoDocumento {
	private DocumentoRepository documentoRepository;
	
	public DeferimentoDocumento () throws Exception {
	...
	public int getCdSituacaoDocumento(CustomConnection customConnection) throws Exception{
		int cdSituacao = ParametroServices.getValorOfParametroAsInteger("CD_SITUACAO_DOCUMENTO_DEFERIDO", 0, 0, customConnection.getConnection());
		if(cdSituacao > 0)
			return cdSituacao;
		
		throw new Exception("Valor para o Parâmetro CD_SITUACAO_DOCUMENTO_DEFERIDO não encontrado.");
	}
}
