...
public class SituacaoIndeferido implements ISituacaoDocumentoOcorrencia {
	...
	public int findTipoOcorrencia() throws Exception {
		int cdDeferido = ParametroServices.getValorOfParametroAsInteger("CD_TIPO_OCORRENCIA_INDEFERIDA", 0);
		if(cdDeferido > 0)
			return cdDeferido;
		
		throw new Exception("Valor para o Parâmetro CD_TIPO_OCORRENCIA_INDEFERIDA não encontrado.");
	}
}
