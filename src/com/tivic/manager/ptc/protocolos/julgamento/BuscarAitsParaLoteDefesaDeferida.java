...
public class BuscarAitsParaLoteDefesaDeferida implements IBuscarAitsParaLoteJulgamento {
	...
	public Search<AitDTO> montarSearchLoteJulgamento(SearchCriterios searchCriterios) throws Exception {
		searchCriterios.addCriteriosEqualInteger("K.tp_status", AitMovimentoServices.DEFESA_DEFERIDA, true);
	...
	public Search<AitDTO> searchAits(SearchCriterios searchCriterios) throws Exception {
		Search<AitDTO> search = new SearchBuilder<AitDTO>("MOB_AIT A")
				...
				.additionalCriterias(" NOT EXISTS"
								   ...
								   + "	AND NOT EXISTS"
								   + "	("
								   + "		SELECT D.cd_lote, D.tp_impressao, E.cd_ait FROM mob_lote_impressao D"
								   + "		JOIN mob_lote_impressao_ait E ON (D.cd_lote = E.cd_lote_Impressao)"
								   + "		WHERE"
								   + "			("
								   + "				D.tp_impressao = " + TipoLoteJulgamentoEnum.LOTE_DEFESA_DEFERIDA.getKey()
								   + "			)"
