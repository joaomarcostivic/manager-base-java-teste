...
public class GerarFormularioCondutorProtocolo implements IGerarFormularioCondutorProtocolo {
	private ILoteNotificacaoService loteNotificacaoService;
	
	public GerarFormularioCondutorProtocolo() throws Exception {
	...
	public byte[] gerarDocumentosCondutor() throws Exception {
		return findFormularioCondutor().getReportPdf("mob/formulario_apresentacao_condutor");
	}
	
	private Report findFormularioCondutor() throws Exception {
