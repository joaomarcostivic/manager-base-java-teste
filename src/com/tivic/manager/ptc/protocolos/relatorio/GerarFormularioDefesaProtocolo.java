...
public class GerarFormularioDefesaProtocolo implements IGerarFormularioDefesaProtocolo {
	private ILoteNotificacaoService loteNotificacaoService;
	
	public GerarFormularioDefesaProtocolo() throws Exception {
	...
	public byte[] gerarDocumentosDefesa() throws Exception {
		return findFormularioDefesa().getReportPdf("mob/formulario_defesa_previa");
	}
	
	private Report findFormularioDefesa() throws Exception {
