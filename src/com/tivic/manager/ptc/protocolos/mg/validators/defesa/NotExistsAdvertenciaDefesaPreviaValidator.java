...
public class NotExistsAdvertenciaDefesaPreviaValidator implements IValidator<DadosProtocoloDTO> {
	@Override
	public void validate(DadosProtocoloDTO object, CustomConnection connection) throws Exception {
		...
		throw new ValidatorException("Já existe uma advertência de defesa previa atrelada ao AIT");
	}
	...
	private SearchCriterios criteriosNaiRegistrada(Ait ait) {
		...
		searchCriterios.addCriteriosEqualInteger("A.tp_status", TipoStatusEnum.ADVERTENCIA_DEFESA_ENTRADA.getKey() , true);
