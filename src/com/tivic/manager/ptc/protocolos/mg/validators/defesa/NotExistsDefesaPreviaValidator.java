...
public class NotExistsDefesaPreviaValidator implements IValidator<DadosProtocoloDTO> {
	@Override
	public void validate(DadosProtocoloDTO object, CustomConnection connection) throws Exception {
		...
		throw new ValidatorException("Já existe uma defesa previa atrelada ao AIT");
	}
	...
	private SearchCriterios criteriosNaiRegistrada(Ait ait) {
		...
		searchCriterios.addCriteriosEqualInteger("A.tp_status", TipoStatusEnum.DEFESA_PREVIA.getKey() , true);
