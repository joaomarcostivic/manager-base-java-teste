...
public class ApresentacaoCondutor {
	...
	public ApresentacaoCondutor(int cdApresentacaoCondutor,
			int cdDocumento,
			String nrCnh,
			String ufCnh,
			int tpCategoriaCnh,
	...
	public Object clone() {
		return new ApresentacaoCondutor(getCdApresentacaoCondutor(),
			getCdDocumento(),
			getNrCnh(),
			getUfCnh(),
			getTpCategoriaCnh(),
