...
public class GeradorMovimentoDocumentoApresentacaoCondutor implements GeradorMovimentoDocumento {
	...
	public GeradorMovimentoDocumentoApresentacaoCondutor(AitMovimento aitMovimento, CustomConnection customConnection) throws Exception{
	...
	public void build() throws Exception{
		Documento documento = new DocumentoBuilder(aitMovimento)
			.cdTipoDocumento(ParametroServices.getValorOfParametroAsInteger("MOB_CD_TIPO_DOCUMENTO_APRESENTACAO_CONDUTOR", 0))
