...
public class GeradorMovimentoDocumentoJariSemProvimento implements GeradorMovimentoDocumento {
	...
	public GeradorMovimentoDocumentoJariSemProvimento(AitMovimento aitMovimento, CustomConnection customConnection) throws Exception{
	...
	public void build() throws Exception{
		Documento documento = new DocumentoBuilder(aitMovimento)
			...
			.cdSituacaoDocumeto(ParametroServices.getValorOfParametroAsInteger("CD_SITUACAO_DOCUMENTO_INDEFERIDO", 0))
		.build();
