...
public class GeradorMovimentoDocumentoRecursoCetran implements GeradorMovimentoDocumento {
	...
	public GeradorMovimentoDocumentoRecursoCetran(AitMovimento aitMovimento, CustomConnection customConnection) throws Exception{
	...
	public void build() throws Exception{
		Documento documento = new DocumentoBuilder(aitMovimento)
			.cdTipoDocumento(ParametroServices.getValorOfParametroAsInteger("MOB_CD_TIPO_DOCUMENTO_CETRAN", 0))
			.cdFase(ParametroServices.getValorOfParametroAsInteger("CD_FASE_PENDENTE", 0))
			.cdSituacaoDocumeto(ParametroServices.getValorOfParametroAsInteger("CD_SITUACAO_PENDENTE", 0))
		.build();
