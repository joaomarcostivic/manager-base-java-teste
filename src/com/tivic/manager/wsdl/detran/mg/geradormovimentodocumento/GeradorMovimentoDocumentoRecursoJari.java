...
public class GeradorMovimentoDocumentoRecursoJari implements GeradorMovimentoDocumento {
	...
	public GeradorMovimentoDocumentoRecursoJari(AitMovimento aitMovimento, CustomConnection customConnection) throws Exception{
	...
	public void build() throws Exception{
		Documento documento = new DocumentoBuilder(aitMovimento)
			.cdTipoDocumento(ParametroServices.getValorOfParametroAsInteger("MOB_CD_TIPO_DOCUMENTO_JARI", 0))
