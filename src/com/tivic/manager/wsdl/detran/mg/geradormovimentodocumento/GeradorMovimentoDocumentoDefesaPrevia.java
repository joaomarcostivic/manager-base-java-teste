...
public class GeradorMovimentoDocumentoDefesaPrevia implements GeradorMovimentoDocumento {
	...
	public GeradorMovimentoDocumentoDefesaPrevia(AitMovimento aitMovimento, CustomConnection customConnection) throws Exception{
