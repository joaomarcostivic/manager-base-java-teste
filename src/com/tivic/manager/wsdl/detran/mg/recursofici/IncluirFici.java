...
import com.tivic.manager.wsdl.detran.mg.recursofici.IncluirFiciDadosEntradaFactory;
...
public class IncluirFici extends ServicoDetran {
	private DetranRegistro detranRegistro;
	
	public IncluirFici() throws Exception {
	...
	public ServicoDetranObjeto executar(AitDetranObject aitDetranObject) {
		try{
			...
			RecursoFiciDadosEntrada incluirFiciDadosEntrada = IncluirFiciDadosEntradaFactory.fazerDadoEntrada(aitDetranObject.getAit(), aitDetranObject.getAitMovimento(), this.arquivoConfiguracao.getLgHomologacao());
