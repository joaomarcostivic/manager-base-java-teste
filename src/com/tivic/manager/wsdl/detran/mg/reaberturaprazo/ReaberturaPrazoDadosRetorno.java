...
public class ReaberturaPrazoDadosRetorno extends DadosRetornoMG{
	...
	public ReaberturaPrazoDadosRetorno() {
		// TODO Auto-generated constructor stub
	}
	
	public ReaberturaPrazoDadosRetorno(String numeroProcessamento, String placa, GregorianCalendar dataNovoPrazoDefesa,
	...
	private void definirDataPrazo() {
		try {
			setDataNovoPrazoFici(new DefinidorDataPrazo().getDataLimiteDefesa(ait, getDataNovoPrazoFici()));
			setDataNovoPrazoDefesa(new DefinidorDataPrazo().getDataLimiteDefesa(ait, getDataNovoPrazoDefesa()));
			setDataNovoPrazoJari(new DefinidorDataPrazo().getDataLimiteDefesa(ait, getDataNovoPrazoJari()));
		} catch (Exception e) {}
	}
}
