...
public class CorreiosDadosEntrada extends DadosEntradaMG{
	...
	public int getSituacaoEntregaCorreio() {
		return Integer.parseInt(itens.get("codigo_retorno_correio").getValor());
	}
	
	public void setSituacaoEntregaCorreio(int situacaoEntregaCorreio) {
		itens.put("codigo_retorno_correio", new DadosItem(String.valueOf(situacaoEntregaCorreio), 3, false));
	}
}
