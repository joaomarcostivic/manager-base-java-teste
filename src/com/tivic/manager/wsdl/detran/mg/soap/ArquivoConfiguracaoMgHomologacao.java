...
public class ArquivoConfiguracaoMgHomologacao implements IArquivoConfiguracaoMg {
	private final String url = "http://homologa3.prodemge.gov.br/sdat/sram/webservice/soap/service";
	private final String prefixUriNameSpace = "ns1";
	private final String uriNameSpace = "http://homologa3.prodemge.gov.br";
	private final String prefixNameSpace = "ns2";
	private final String nameSpace = "SRAM";
	private final String cnpj = "18404780000109";
	private final String chave = "e5c79e47a7d4fb2897b9b687efc825a3";
