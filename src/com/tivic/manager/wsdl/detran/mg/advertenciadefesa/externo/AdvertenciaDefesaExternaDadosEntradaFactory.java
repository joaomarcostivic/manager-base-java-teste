...
public class AdvertenciaDefesaExternaDadosEntradaFactory {
	
static TabelasAuxiliaresMG tabelasAuxiliaresMG = new TabelasAuxiliaresMG();
	
	public static AdvertenciaDefesaDadosEntrada fazerDadoEntrada(ProtocoloExternoDetranObject protocoloExternoDetranObject, boolean lgHomologacao) throws Exception{
		...
		advertenciaDefesaDadosEntrada.setNmServico("ADVERTENCIA DEFESA EXTERNA");
