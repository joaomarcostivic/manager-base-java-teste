...
public class CancelarAdvertenciaDefesaDadosEntradaFactory {
	...
	public static AdvertenciaDefesaDadosEntrada fazerDadoEntrada(AitDetranObject aitDetranObject, boolean lgHomologacao) throws Exception{
		...
		advertenciaDefesaDadosEntrada.setCodigoMovimentacao(aitMovimento.getTpStatus());
		...
		advertenciaDefesaDadosEntrada.setNmServico("CANCELAR ADVERTENCIA DEFESA");
