...
public class AdvertenciaDefesa extends ServicoDetran {
	private DetranRegistro detranRegistro;
	
	public AdvertenciaDefesa() throws Exception {
	...
	public ServicoDetranObjeto executar(AitDetranObject aitDetranObject) {
		try{
			...
			AdvertenciaDefesaDadosEntrada advertenciaDefesaDadosEntrada = AdvertenciaDefesaDadosEntradaFactory.fazerDadoEntrada(aitDetranObject, this.arquivoConfiguracao.getLgHomologacao());
