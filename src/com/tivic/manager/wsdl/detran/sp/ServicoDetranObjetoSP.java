...
public class ServicoDetranObjetoSP implements ServicoDetranObjeto {

	private Ait ait;
	private AitMovimento aitMovimento;
	private DadosEntradaSP dadosEntrada;
	private DadosRetornoSP dadosRetorno;
	
	public ServicoDetranObjetoSP() {
		// TODO Auto-generated constructor stub
	}

	public ServicoDetranObjetoSP(Ait ait, AitMovimento aitMovimento, DadosEntradaSP dadosEntrada, DadosRetornoSP dadosRetorno) {
		super();
		this.ait = ait;
	...
	@Override
	public DadosEntradaSP getDadosEntrada() {
		return dadosEntrada;
	}

	@Override
	public void setDadosEntrada(DadosEntrada dadosEntrada) {
		this.dadosEntrada = (DadosEntradaSP) dadosEntrada;
	}

	@Override
	public DadosRetornoSP getDadosRetorno() {
		return dadosRetorno;
	}

	@Override
	public void setDadosRetorno(DadosRetorno dadosRetorno) {
		this.dadosRetorno = (DadosRetornoSP) dadosRetorno;
	}
